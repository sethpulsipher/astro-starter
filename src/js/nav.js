...
document.addEventListener('astro:page-load', () => { // Make the script controlling the <Hamburger /> mobile menu component available after navigating to a new page.
    ...
    const CSnavbarMenu = document.getElementById('navigation');
    const CSUlWrapper = document.getElementById('ul-wrapper');
    ...
    dropdownElements.forEach(element => {
        ...
        // This variable tracks if the Escape key was pressed. This flag will be checked in the focusout event handler to ensure that pressing the Escape key does not trigger the focusout event and subsequently remove the active class from the dropdown
